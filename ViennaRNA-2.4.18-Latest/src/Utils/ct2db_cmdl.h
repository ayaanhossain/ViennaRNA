...
struct ct2db_args_info
{
 ...
 help description.  */
  int convertToRNA_flag;	/**< @brief Substitute all nucleotides with their RNA alphabet counter parts, i.e. convert to characters A, C, G, U or N for unknown bases.
 (default=off).  */
  const char *convertToRNA_help; /**< @brief Substitute all nucleotides with their RNA alphabet counter parts, i.e. convert to characters A, C, G, U or N for unknown bases.
 help description.  */
 ...
 help description.  */
  ...
  unsigned int convertToRNA_given ;	/**< @brief Whether convertToRNA was given.  */
