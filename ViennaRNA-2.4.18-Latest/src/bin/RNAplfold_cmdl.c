...
init_full_help_array(void)
{
  ...
  RNAplfold_args_info_full_help[34] = RNAplfold_args_info_detailed_help[52];
  RNAplfold_args_info_full_help[35] = RNAplfold_args_info_detailed_help[54];
  RNAplfold_args_info_full_help[36] = RNAplfold_args_info_detailed_help[56];
  RNAplfold_args_info_full_help[37] = RNAplfold_args_info_detailed_help[58];
  RNAplfold_args_info_full_help[38] = RNAplfold_args_info_detailed_help[60];
  RNAplfold_args_info_full_help[39] = RNAplfold_args_info_detailed_help[62];
...
init_help_array(void)
{
  ...
  RNAplfold_args_info_help[25] = RNAplfold_args_info_detailed_help[62];
  RNAplfold_args_info_help[26] = 0; 
  
}

const char *RNAplfold_args_info_help[27];
...
void init_args_info(struct RNAplfold_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNAplfold_args_info_detailed_help[50] ;
  args_info->pfScale_help = RNAplfold_args_info_detailed_help[52] ;
  args_info->binaries_help = RNAplfold_args_info_detailed_help[54] ;
  args_info->nsp_help = RNAplfold_args_info_detailed_help[56] ;
  args_info->energyModel_help = RNAplfold_args_info_detailed_help[58] ;
  args_info->betaScale_help = RNAplfold_args_info_detailed_help[60] ;
