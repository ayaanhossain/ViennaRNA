...
START_TEST(test_pack_unpack_structure)
{
#line 217
{
  int i;
...
START_TEST(test_pack_lexicographic_order)
{
#line 246
{
  int i, j, k, l, m;
...
int main(void)
{
    ...
    tcase_add_test(tc1_3, test_pack_unpack_structure);
    tcase_add_test(tc1_3, test_pack_lexicographic_order);
