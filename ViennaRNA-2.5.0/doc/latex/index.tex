...
\begin{DoxyItemize}
\item Daniel Wiegreffe (RNAturtle and RNApuzzler secondary structure layouts)
\item Andreas Gruber (first approach on RNALfold Z-\/score filtering)
...
\item Stephan Bernhart (RNAcofold, RNAplfold, unpaired probabilities, alifold, and so many more)
\item Stefan Wuchty (RNAsubopt)
