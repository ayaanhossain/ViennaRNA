...
init_full_help_array(void)
{
  ...
  RNAup_args_info_full_help[29] = RNAup_args_info_detailed_help[42];
  RNAup_args_info_full_help[30] = RNAup_args_info_detailed_help[44];
  RNAup_args_info_full_help[31] = RNAup_args_info_detailed_help[46];
...
init_help_array(void)
{
  ...
  RNAup_args_info_help[28] = RNAup_args_info_detailed_help[46];
...
void init_args_info(struct RNAup_args_info *args_info)
{
  ...
  args_info->paramFile_help = RNAup_args_info_detailed_help[40] ;
  args_info->nsp_help = RNAup_args_info_detailed_help[42] ;
  args_info->energyModel_help = RNAup_args_info_detailed_help[44] ;
