...
init_full_help_array(void)
{
  ...
  RNAplot_args_info_full_help[8] = RNAplot_args_info_detailed_help[12];
  RNAplot_args_info_full_help[9] = RNAplot_args_info_detailed_help[13];
  ...
  RNAplot_args_info_full_help[15] = RNAplot_args_info_detailed_help[21];
  RNAplot_args_info_full_help[16] = RNAplot_args_info_detailed_help[22];
  ...
  RNAplot_args_info_full_help[19] = RNAplot_args_info_detailed_help[26];
  RNAplot_args_info_full_help[20] = RNAplot_args_info_detailed_help[27];
  RNAplot_args_info_full_help[21] = RNAplot_args_info_detailed_help[29];
  RNAplot_args_info_full_help[22] = RNAplot_args_info_detailed_help[31];
  RNAplot_args_info_full_help[23] = RNAplot_args_info_detailed_help[33];
  RNAplot_args_info_full_help[24] = RNAplot_args_info_detailed_help[35];
  RNAplot_args_info_full_help[25] = RNAplot_args_info_detailed_help[37];
  RNAplot_args_info_full_help[26] = RNAplot_args_info_detailed_help[39];
...
init_help_array(void)
{
  ...
  RNAplot_args_info_help[8] = RNAplot_args_info_detailed_help[12];
  RNAplot_args_info_help[9] = RNAplot_args_info_detailed_help[13];
  RNAplot_args_info_help[10] = RNAplot_args_info_detailed_help[16];
  RNAplot_args_info_help[11] = RNAplot_args_info_detailed_help[25];
  RNAplot_args_info_help[12] = RNAplot_args_info_detailed_help[26];
  RNAplot_args_info_help[13] = RNAplot_args_info_detailed_help[27];
  RNAplot_args_info_help[14] = RNAplot_args_info_detailed_help[29];
  RNAplot_args_info_help[15] = RNAplot_args_info_detailed_help[41];
  RNAplot_args_info_help[16] = 0; 
  
}

const char *RNAplot_args_info_help[17];
...
void init_args_info(struct RNAplot_args_info *args_info)
{
  ...
  args_info->covar_help = RNAplot_args_info_detailed_help[12] ;
  args_info->aln_help = RNAplot_args_info_detailed_help[13] ;
  args_info->aln_EPS_cols_help = RNAplot_args_info_detailed_help[14] ;
  args_info->layout_type_help = RNAplot_args_info_detailed_help[16] ;
  args_info->noOptimization_help = RNAplot_args_info_detailed_help[18] ;
  args_info->ignoreExteriorIntersections_help = RNAplot_args_info_detailed_help[19] ;
  args_info->ignoreAncestorIntersections_help = RNAplot_args_info_detailed_help[20] ;
  args_info->ignoreSiblingIntersections_help = RNAplot_args_info_detailed_help[21] ;
  args_info->allowFlipping_help = RNAplot_args_info_detailed_help[22] ;
  args_info->output_format_help = RNAplot_args_info_detailed_help[23] ;
  args_info->pre_help = RNAplot_args_info_detailed_help[25] ;
  args_info->post_help = RNAplot_args_info_detailed_help[26] ;
  args_info->auto_id_help = RNAplot_args_info_detailed_help[27] ;
  args_info->id_prefix_help = RNAplot_args_info_detailed_help[29] ;
  args_info->id_delim_help = RNAplot_args_info_detailed_help[31] ;
  args_info->id_digits_help = RNAplot_args_info_detailed_help[33] ;
  args_info->id_start_help = RNAplot_args_info_detailed_help[35] ;
  args_info->filename_delim_help = RNAplot_args_info_detailed_help[37] ;
  args_info->filename_full_help = RNAplot_args_info_detailed_help[39] ;
